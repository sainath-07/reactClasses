  ...
  return (
    ...
    <div id="flex">
    {
      fakestoreapi.map((eachObjects)=>{
        ...
        return(
           <Cards title={title} price={price} description={description} image={image} key={id}/>
        )
      })
      ...
      <h1>Good night</h1>
         ...
         {/*PropwithMapMethods file  */}
    {/* {
      Proparray.map((eachvalue)=>{
        const {id,text,bgcolor,width,height}=eachvalue
           return(
            <ButtonProp key={id}  text={text} bgcolor={bgcolor}
            buttonProperties ={{
              width:width,
              height:height
            }}
     ...
     <ButtonProp text={"sing up "}  bgcolor={"red"}  buttonproperties={{
      width : "150px",
      height : "100px"
     }}/>
