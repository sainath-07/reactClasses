    ...
    <>
      ...
      <div className="offset-lg-3 col-lg-6">
              ...
              <div className="row">
                <div className="col-lg-6">
                  <div className="form-group">
                    ...
                    />
                    {
                      Emailvalue && <span style={{color:"red"}}>{Emailerror}</span>
                    }
                ...
                <div className="col-lg-6">
                  <div className="form-group">
                    ...
                    {
                      phvalue && <span style={{color:"red"}}>{showpherror}</span>
                    }
                  </div>
                </div>
                ...
                <div className="col-lg-12 mt-2">
                  <div className="form-group">
                    ...
                    <div className="form-floating">
                      ...
                      />
                      <label className="mt-1 p-0 text-sm text-wrap" htmlFor="floatingTextarea2">
        ...
        <div className="mt-3 d-flex justify-content-center">
            ...
            <button className="btn btn-primary "  type="submit"><Link className="text-white text-decoration-none" to={'/login'}>Login</Link></button>
